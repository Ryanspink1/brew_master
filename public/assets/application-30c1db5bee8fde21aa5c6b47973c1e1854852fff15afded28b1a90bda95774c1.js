...
function refreshScrollSpy() {
    $("#all-events-nav-link").removeClass('active')
    $("#new-events-nav-link").addClass('active')
}
;
...
function scrollToTop(){
    // $(window).scrollTop(0);
    $("#user-dashboard-events-list").scrollTop(0)
}

function breweryIndexScrollToTop(){
$("#brewery-index-table").scrollTop(0)
}
;
        ...
        <div class="col">
          <div class="user-dashboard-event">
             ...
             <div class="user-dashboard-event-body">
               <p>${formatDate(new Date(userEvents[i].start_time))}-${formatDate(new Date(userEvents[i].end_time))}</p>
